...
The aim of Freehand US reconstruction is to estimate the transformation between any pair of US frames in a US scan without any external tracker, and thus reconstruct 2D Ultrasound (US) images into a 3D volume (see [Figure 1](#figure1)).
...
<div align=center>
Figure 1: An example workflow of freehand US reconstruction.
</div >
<!-- <p align="center">
