...
The evaluation code, together with the baseline models, will be publicly available once this section on our website is open to public. Participating teams are encouraged, though not obligated, to share their code publicly. Links to any available source code will be provided.
